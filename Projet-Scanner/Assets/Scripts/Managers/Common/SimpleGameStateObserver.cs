...
public abstract class SimpleGameStateObserver : MonoBehaviour, IEventHandler
{
	public virtual void SubscribeEvents()
	{
		...
		EventManager.Instance.AddListener<GameSettingsChangedEvent>(GameSettingsChanged);
	}
	public virtual void UnsubscribeEvents()
	{
		...
		EventManager.Instance.RemoveListener<GameSettingsChangedEvent>(GameSettingsChanged);
	}
	...
	protected virtual void GameSettingsChanged(GameSettingsChangedEvent e)
	{
	}
}